MODULE usrdef_zgr
   ...
   !!======================================================================
   !! History :  4.0  ! 2026-06  (J. Chanut)  Original code
   !!----------------------------------------------------------------------
...
CONTAINS             
   ...
   SUBROUTINE usr_def_zgr( ld_zco  , ld_zps  , ld_sco  , ld_isfcav,    &   ! type of vertical coordinate
      ...
      !
      IF(lwp) WRITE(numout,*)
      IF(lwp) WRITE(numout,*) 'usr_def_zgr : SOLITON configuration (z-coordinate closed flat box ocean)'
      IF(lwp) WRITE(numout,*) '~~~~~~~~~~~'
      !
      !
      ! type of vertical coordinate
      ! ---------------------------
      ld_zco    = .TRUE.         ! SOLITON case:  z-coordinate without ocean cavities
      ld_zps    = .FALSE.
      ld_sco    = .FALSE.
      ld_isfcav = .FALSE.
      !
   ...
   SUBROUTINE zgr_z( pdept_1d, pdepw_1d, pe3t_1d , pe3w_1d )   ! 1D reference vertical coordinate
      ...
      !!----------------------------------------------------------------------
      !
      zd = 1._wp/REAL(jpkm1,wp)
      !
      IF(lwp) THEN            ! Parameter print
         WRITE(numout,*)
         WRITE(numout,*) '    zgr_z   : Reference vertical z-coordinates '
         WRITE(numout,*) '    ~~~~~~~'
         WRITE(numout,*) '       SOLITON case : uniform vertical grid :'
   ...
   SUBROUTINE zgr_msk_top_bot( k_top , k_bot )
      ...
      !!
      !! ** Method  :   SOLITON case = closed flat box ocean without ocean cavities
      ...
      IF(lwp) WRITE(numout,*) '    ~~~~~~~~~~~'
      IF(lwp) WRITE(numout,*) '       SOLITON case : closed flat box ocean without ocean cavities'
      !
