MODULE par_oce
   ...
   ! time dimension
   INTEGER, PUBLIC, PARAMETER :: jpt = 1    !: time dimension (reduced from 3 to 1 : spare 3 times the memory for uu, vv and ts.)
   ...
   !!---------------------------------------------------------------------
   INTEGER, PUBLIC, PARAMETER ::   jpts   = 1    !: Number of active tracers (=1, i.e. only T)
