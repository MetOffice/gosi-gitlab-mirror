...
CONTAINS
   ...
   SUBROUTINE dom_nam
      ...
      NAMELIST/namrun/ cn_ocerst_indir, cn_ocerst_outdir, nn_stocklist, ln_rst_list,                 &
         ...
         &             ln_xios_read, nn_wxios
      NAMELIST/namdom/ rn_Dt, ln_c1d, ln_meshmask
      ...
      IF(lwp) THEN                  ! control print
         ...
         WRITE(numout,*) '      file prefix restart input       cn_icbrst_in    = ', TRIM( cn_ocerst_in     )
         WRITE(numout,*) '      restart input directory         cn_icbrst_indir = ', TRIM( cn_ocerst_indir  )
         WRITE(numout,*) '      file prefix restart output      cn_icbrst_out   = ', TRIM( cn_ocerst_out    )
         WRITE(numout,*) '      restart output directory        cn_icbrst_outdir= ', TRIM( cn_ocerst_outdir )
