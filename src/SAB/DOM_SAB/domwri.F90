...
CONTAINS
   ...
   SUBROUTINE dom_wri
      ...
      !
      CALL iom_rstput( 0, 0, inum, 'glamu', glamu, ktype = jp_r8 )     !    ! latitude
      CALL iom_rstput( 0, 0, inum, 'gphiu', gphiu, ktype = jp_r8 )     !    ! longitude
      !
      CALL iom_rstput( 0, 0, inum, 'glamv', glamv, ktype = jp_r8 )     !    ! latitude
      CALL iom_rstput( 0, 0, inum, 'gphiv', gphiv, ktype = jp_r8 )     !    ! longitude
      ! 
      CALL iom_rstput( 0, 0, inum, 'glamf', glamf, ktype = jp_r8 )     !    ! latitude
      CALL iom_rstput( 0, 0, inum, 'gphif', gphif, ktype = jp_r8 )     !    ! longitude
