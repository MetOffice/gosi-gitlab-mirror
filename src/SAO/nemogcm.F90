MODULE nemogcm
   ...
   USE sbc_oce, ONLY : sbc_oce_alloc        ! Surface-boundary-condition array allocation
...
904   IF( ios >  0 )   CALL ctl_nam ( ios , 'namcfg in configuration namelist' )   
      ...
      !
#if defined key_si3
      IF( sbc_oce_alloc() /= 0 ) CALL ctl_stop( '   SAO: allocation of surface-boundary-condition arrays failed' )
#endif
      !
