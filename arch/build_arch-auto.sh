...
-----------------------------------------
  ...
  FCFLAGSnemo : fortran compiler options
            Can also be specified with the optional argument --FCFLAGSnemo
...
#
#-----------------------------------------------------
# C Compiler (not critical, needed only for the conv of AGRIF)
#-----------------------------------------------------
#
# first guess
case "$ftncomp" in
